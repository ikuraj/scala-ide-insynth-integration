package ch.epfl.insynth.leon

import scala.tools.nsc._
import scala.tools.nsc.plugins._

import leon.purescala.Definitions._
import leon.purescala.Trees.{Block => PBlock, _}
...
class CodeExtractionForInSynth(val global: Global, val pluginInstance: LeonPlugin) extends Extractors {
