...
class CodeGenerationTests {
  ...
  def testApplyTransformer() = {
    ...
    val functionType = Function(List(typeInt), typeString)
    val functionDeclaration = new ScalaDeclaration(
      "ObjectName", // full name
      transform(methodType), functionType)
    
	  val queryType = Function(List(typeString), typeBottom)
	  val queryDeclaration = new ScalaDeclaration(
    ...
    // declare nodes
    val queryIdentifier = Identifier(queryType, queryDeclaration)
    ...
    val methodRootNode = Application(Scala.Function(List(typeString), typeBottom), List(queryIdentifier, methodApplicationNode))
    ...
    val functionRootNode = Application(Scala.Function(List(typeString), typeBottom), List(queryIdentifier, functionApplicationNode))
  ...
  def testSSimpleApplicationNamesTransfromer() = {
    ...
    def testMethodCase(keyIntoTransformer: String, mappedName: String) = {
      ...
      val methodRootNodeTransformed = Application(Scala.Function(List(typeString), typeBottom), List((queryIdentifier), (methodApplicationNodeTransformed)))
    ...
    def testFunctionCase(keyIntoTransformer: String, mappedName: String) = {
      ...
      val functionRootNodeTransformed = Application(Scala.Function(List(typeString), typeBottom), List((queryIdentifier), (functionApplicationNodeTransformed)))
