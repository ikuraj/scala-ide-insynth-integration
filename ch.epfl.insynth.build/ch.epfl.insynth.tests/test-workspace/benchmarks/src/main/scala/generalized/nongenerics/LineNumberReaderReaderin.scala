package gjavaapi.LineNumberReaderReaderin
...
class MainClass {
  ...
  def main(args:Array[String]) {
    //var lineCounter:LineNumberReader = new LineNumberReader(new InputStreamReader(System.in)) //r>5
    var lineCounter:LineNumberReader =  /*!*/ //r>5
