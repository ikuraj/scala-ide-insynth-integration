package gjavaapi.PriorityQueuepoll

//http://www.java2s.com/Code/JavaAPI/java.util/PriorityQueuepoll.htm
...
class Main {
  def main(args:Array[String]) {
    ...
    var pq:PriorityQueue[Product] = new PriorityQueue[Product](3)
