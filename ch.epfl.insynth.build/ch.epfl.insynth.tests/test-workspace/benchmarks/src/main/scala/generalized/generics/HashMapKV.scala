package gjavaapi.HashMapKV

//http://www.java2s.com/Code/JavaAPI/java.util/newHashMapKV.htm
...
object MainClass {
  def main(args:String) {
    ...
    var hm:HashMap[String, Double] = new HashMap[String,Double]() //r=1
