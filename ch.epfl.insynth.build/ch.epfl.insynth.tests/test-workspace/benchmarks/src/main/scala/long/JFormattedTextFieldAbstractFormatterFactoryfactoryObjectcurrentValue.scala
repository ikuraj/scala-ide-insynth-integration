package long.javaapi.JFormattedTextFieldAbstractFormatterFactoryfactoryObjectcurrentValue
...
class MainClass {
  def main(args:Array[String]){
    ...
    var date2TextField:JFormattedTextField = new JFormattedTextField(
      new DefaultFormatterFactory(new DateFormatter(new SimpleDateFormat("yyyy--MMMM--dd")),
      new DateFormatter(new SimpleDateFormat("yyyy--MMMM--dd")),
      new DateFormatter(new SimpleDateFormat("MM/dd/yy")))) //r>5
